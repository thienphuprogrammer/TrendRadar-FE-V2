  ...
  $driver.setSteps([
    {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            Create and manage <b>Question-SQL pairs</b> to refine TrendRadarAI’s SQL
            ...
            save, the smarter TrendRadarAI becomes!
          </>,
        ),
        onPopoverRender: (popoverDom: DriverPopoverDOM) => {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            ...
            guide TrendRadarAI in applying consistent filters, constraints, and best
